...
class index<Alphabet, Source, ParseKeeper, LiteralKeeper>::builder : public rlz::build::observer<Alphabet> {
  using Symbol        = typename Alphabet::Symbol;
  using Index         = index<Alphabet, Source,ParseKeeper, LiteralKeeper>;
  using LitBuilder    = typename LiteralKeeper::builder;
  using ParseBuilder  = typename ParseKeeper::builder;
...
public:
  ...
  size_t can_split(size_t source, size_t target, size_t len, size_t junk_len, const Symbol *chars) override
  {
    return std::min(
  ...
  bool split_as_block(size_t source, size_t target, size_t len, size_t junk_len, const Symbol *chars) override
  {
