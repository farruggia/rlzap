...
// Alphabets
using alphabets      = type_utils::type_list<rlz::alphabet::lcp_32>;
...
using sample_intvals = type_utils::type_list<values::Size<16U>, values::Size<32U>, values::Size<48U>>;
...
using diff_sizes     = type_utils::type_list<values::Size<2UL>, values::Size<4UL>, values::Size<8UL>/*, values::Size<16UL>*/>;
...
using configurations = rlzap_confs;
}
